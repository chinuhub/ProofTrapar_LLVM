...
//        faudes::Idx s2=rCompositionMap.Arg2State(*sit);
//
//        if(faudesAutomata.at(0).ExistsMarkedState(s1) && faudesAutomata.at(1).ExistsMarkedState(s2)) {
//
//            auto currentstates = std::make_pair(s1, s2);
//
//            result.SetMarkedState(rCompositionMap[currentstates]);
//        }
//    }


/*
 * Changes in product automaton over
 */
