...
/**
 * Language intersection and returning an accepted word(minimal)- combining both
 * algorithms, using get_example implementation from auges library..
 *
 * See also LanguageUnion(const Generator&, const Generator&, Generator&);
 * This version takes a vector of generators as argument to perform
 * the intersection for multiple languages. The implementation
 ...
 *
 */
std::string LanguageIntersectionWithWord(const Generator& rGen1, const Generator& rGen2, Generator& rResGen);
/**
 ...
 * @ingroup GeneratorFunctions
 */
void LanguageDifference(const Generator& rGen1, const Generator& rGen2,
                 Generator& rResGen);
