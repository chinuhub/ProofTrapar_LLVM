...
template <class GlobalAttr, class StateAttr, class EventAttr, class TransAttr>
  class TdiagGenerator : public TcGenerator <GlobalAttr, StateAttr, EventAttr, TransAttr> {
 ...
 public:  
     ...
     *   Other generator
     */
    virtual TdiagGenerator& operator= (const TdiagGenerator& rOtherGen) {this->Assign(rOtherGen); return *this;};
