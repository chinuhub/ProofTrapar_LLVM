...
class AttributeSignalOutput : public AttributeVoid {
...
class AttributeSignalInput : public AttributeVoid {
...
class AttributeSignalEvent : public AttributeDeviceEvent {
