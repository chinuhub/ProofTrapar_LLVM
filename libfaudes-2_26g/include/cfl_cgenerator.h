...
template <class GlobalAttr, class StateAttr, class EventAttr, class TransAttr>
    class TcGenerator : public TaGenerator<GlobalAttr, StateAttr, EventAttr, TransAttr> {    
  public:
    /**
     ...
     *   Other generator
     */
     virtual TcGenerator& operator= (const TcGenerator& rOtherGen) { this->Assign(rOtherGen); return *this;};
     ...
     *   Other generator
     */
     virtual TcGenerator& operator= (const vGenerator& rOtherGen) {this->Assign(rOtherGen); return *this;};
