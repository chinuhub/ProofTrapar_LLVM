...
class AttributeDeviceEvent : public AttributeVoid {
...
class vDevice : public Type {
 ...
 public:
   ...
   *
   */
  void Tolerance(tpTime::Type maxgap) {mMaxSyncGap=maxgap;};
   ...
   *
   */
  tpTime::Type Tolerance(void) {return mMaxSyncGap;};
