...
#define FAUDES_TYPE_DECLARATION_NEW(ftype,ctype,cbase)	\
  public: virtual ctype* New(void) const; 
#define FAUDES_TYPE_DECLARATION_COPY(ftype,ctype,cbase)	\
  public: virtual ctype* Copy(void) const; 
#define FAUDES_TYPE_DECLARATION_CAST(ftype,ctype,cbase)	\
  public: virtual const Type* Cast(const Type* pOther) const; 
#define FAUDES_TYPE_DECLARATION_ASSIGN(ftype,ctype,cbase) \
...
class Documentation : public Type {
...
class TypeDefinition : public Documentation {
