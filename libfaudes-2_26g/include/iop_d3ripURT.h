...
public:
 ...
 protected:
   ...
   */
  virtual void DoAssign(const AttributeD3ripURTOutput& rSrcAttr);
...
public:
 ...
 protected:
   ...
   *   Ref to this attribute
   */
  virtual void DoAssign(const AttributeD3ripURTInput& rSrcAttr);
...
FAUDES_TYPE_DECLARATION(Void,AttributeD3ripURTEvent,AttributeDeviceEvent)
 ...
 protected:
  ...
  /** DoAssign */
  virtual void DoAssign(const AttributeD3ripURTEvent& rSrc)  
...
public:
 ...
 protected:
  ...
  // dummies
  virtual void DoAssign(const d3ripURTDevice& rSrcAttr){};
