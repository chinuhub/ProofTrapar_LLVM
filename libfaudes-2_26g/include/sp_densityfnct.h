...
class DiscreteDensityFunction {
 ...
 public:
  ...
  CIterator At(tpTime::Type time) const { return mValueMap.lower_bound(time);} ;
  ...
  Iterator At(tpTime::Type time)        { return mValueMap.lower_bound(time);} ;
  ...
  tpTime::Type MaxTime(void) const  { return mMaxTime; };
  tpTime::Type MinTime(void) const  { return mMinTime; };
...
class SampledDensityFunction : public DiscreteDensityFunction {
 ...
 protected:
  ...
  // convenience typedef 
  typedef std::map<tpTime::Type,CountEntry>::iterator CountIterator;
  typedef std::map<tpTime::Type,CountEntry>::const_iterator CCountIterator;

  // map of all support intervals
  std::map<tpTime::Type,CountEntry> mCountMap;
