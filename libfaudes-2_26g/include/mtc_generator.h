...
template <class GlobalAttr, class StateAttr, class EventAttr, class TransAttr>
  class TmtcGenerator : public TcGenerator<GlobalAttr, StateAttr, EventAttr, TransAttr> {
 ...
 public:
     ...
     *
     * @param rSrc
     *   Generator which will become the copy
     */
...
// Assign(gen)
TEMP THIS& THIS::Assign(const TmtcGenerator& rSrc) {
  FD_DG("MtcSystem(" << this << ")::Assign(gen&)");
  // call base method
  BASE::Assign(rSrc);
  // my members
...
// Assign(gen)
TEMP THIS& THIS::Assign(const vGenerator& rSrc) {
  FD_DG("MtcSystem(" << this << ")::Assign(vgen&)");
  // call base method
  BASE::Assign(rSrc);
  // done
  return *this;
