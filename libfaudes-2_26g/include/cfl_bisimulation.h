...
*/
void calcBisimulation(const Generator& rGenOrig, std::map<Idx,Idx>& rMapStateToPartition);
...
* @ingroup GeneratorFunctions
*/
void calcBisimulation(const Generator& rGenOrig, std::map<Idx,Idx>& rMapStateToPartition, Generator& rGenPart);
