 ...
 */
PushdownGenerator AnnotatePdStates(const std::string word,
 ...
 *    copy of the parameter automaton with annotated states
 */
PushdownGenerator RenameStackSymbold(const std::string word,
		const PushdownGenerator& pd);
 ...
 * 		pushdown generator
 */
PushdownGenerator RebuildFromSPDA(const PushdownGenerator& rSPDA,
