...
typedef std::tr1::shared_ptr<GrammarSymbol> GrammarSymbolPtr;
typedef std::tr1::shared_ptr<const GrammarSymbol> ConstGrammarSymbolPtr;

//convenience definition for a nonterminal pointer that manages its own memory
typedef std::tr1::shared_ptr<Nonterminal> NonterminalPtr;
typedef std::tr1::shared_ptr<const Nonterminal> ConstNonterminalPtr;

//convenience definition for a terminal pointer that manages its own memory
typedef std::tr1::shared_ptr<Terminal> TerminalPtr;
typedef std::tr1::shared_ptr<const Terminal> ConstTerminalPtr;
